...
import SubGoalEditItem from "./SubGoalEditItem"; // 실제 컴포넌트 파일 임포트

const meta = {
  title: "Components/SubGoalEditItem", // Storybook 사이드바 경로 (프로젝트 규칙에 맞게 수정)
  component: SubGoalEditItem,
  parameters: {
  ...
  args: {
    // 예시: label: 'SubGoalEditItem',
  },
} satisfies Meta<typeof SubGoalEditItem>;
...
export const Secondary: Story = {
  args: {
    label: 'Secondary SubGoalEditItem',
  },
};
