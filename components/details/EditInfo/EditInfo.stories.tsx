...
import EditInfo from "./EditInfo"; // 실제 컴포넌트 파일 임포트

const meta = {
  title: "Components/EditInfo", // Storybook 사이드바 경로 (프로젝트 규칙에 맞게 수정)
  component: EditInfo,
  parameters: {
...
} satisfies Meta<typeof EditInfo>;
...
export const Primary: Story = {
  argTypes: {
    type: { control: "select", options: ["goal", "subGoal"] },
