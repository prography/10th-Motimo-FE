...
import GoalData from "./GoalData"; // 실제 컴포넌트 파일 임포트

const meta = {
  title: "Components/GoalData", // Storybook 사이드바 경로 (프로젝트 규칙에 맞게 수정)
  component: GoalData,
  parameters: {
...
} satisfies Meta<typeof GoalData>;
