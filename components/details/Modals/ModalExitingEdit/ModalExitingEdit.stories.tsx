...
import ModalExitingEdit from "./ModalExitingEdit"; // 실제 컴포넌트 파일 임포트

const meta = {
  title: "Details/Modals/ModalExitingEdit", // Storybook 사이드바 경로 (프로젝트 규칙에 맞게 수정)
  component: ModalExitingEdit,
  parameters: {
  ...
  args: {
    // 예시: label: 'ModalExitingEdit',
  },
} satisfies Meta<typeof ModalExitingEdit>;
...
export const Secondary: Story = {
  args: {
    label: 'Secondary ModalExitingEdit',
  },
};
