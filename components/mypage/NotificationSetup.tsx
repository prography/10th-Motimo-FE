...
export function NotificationSetup({ onBack, className = "" }: NotificationSetupProps) {
    ...
    const handleToggleChange = (key: keyof NotificationSettings, currentValue: boolean) => {
                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex items-center gap-3 px-4 py-4">
                        ...
                        <Toggle
                            ...
                            onChange={(currentValue) => handleToggleChange("todoDeadline", currentValue)}
                        />
                    </div>
                    ...
                    {settings.todoDeadline && (
                        <div className="bg-Color-gray-5 px-6 py-2">
                            <div className="flex items-center gap-1">
                                <span className="text-sm font-medium text-Color-gray-90">설정한 마감일</span>

                                {/* Dropdown */}
                                <div className="relative">
                                    <select
                                        value={settings.deadlineAdvance}
                                        onChange={(e) => handleDeadlineAdvanceChange(e.target.value)}
                                ...
                                <span className="text-sm font-medium text-Color-gray-90">전에 알림이 갑니다.</span>
                            </div>
                        </div>
                    )}
                    ...
                    <div className="flex items-center gap-3 px-4 py-4">
                        ...
                        <Toggle
                            ...
                            onChange={(currentValue) => handleToggleChange("groupNotifications", currentValue)}
                        />
                    </div>
                    ...
                    <div className="flex items-center gap-3 px-4 py-4">
                        ...
                        <Toggle
                            ...
                            onChange={(currentValue) => handleToggleChange("nudgeNotifications", currentValue)}
                        />
                    </div>
                    ...
                    <div className="flex items-center gap-3 px-4 py-4">
                        ...
                        <Toggle
                            ...
                            onChange={(currentValue) => handleToggleChange("feedbackNotifications", currentValue)}
                        />
                    </div>
                </div>
            </div>
