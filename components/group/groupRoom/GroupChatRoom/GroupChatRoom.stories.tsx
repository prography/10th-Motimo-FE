...
import GroupChatRoom from "./GroupChatRoom"; // 실제 컴포넌트 파일 임포트

const meta = {
  title: "Group/GroupRoom/GroupChatRoom", // Storybook 사이드바 경로 (프로젝트 규칙에 맞게 수정)
  ...
  args: {
    // 예시: label: 'GroupChatRoom',
  },
} satisfies Meta<typeof GroupChatRoom>;
